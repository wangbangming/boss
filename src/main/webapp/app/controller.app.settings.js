...
angular.module('app').controller('AppCtrl', [
    ...
    function ($rootScope, $localStorage, $state) {
        var MT = 'controller.app.settings.js - AppCtrl - ';
        c.log(MT, '...');
        ...
        $rootScope.$on('$viewContentLoaded',
            function (event, toState, toParams, fromState, fromParams) {
                c.log(MT, '$viewContentLoaded...$state.current.name:', $state.current.name);
                /*if ($rootScope.settings.rtl
                    && $state.current.name != "persian.dashboard"
                    && $state.current.name != "arabic.dashboard") {
                    switchClasses("pull-right", "pull-left");
                    switchClasses("databox-right", "databox-left");
                    switchClasses("item-right", "item-left");
                }*/
